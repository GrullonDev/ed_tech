...
| `cloud_firestore` | `^5.4.4` | Perfil de usuario (`users/{uid}`) y espejo de círculos/check-ins reales |
| `firebase_analytics` | `^11.3.4` | Eventos de producto (check-in, hito, círculo creado, aliados) y vistas de pantalla |
